...
public class DatabaseConfiguration {
	 ...
	 * LocalContainerEntityManagerFactoryBean getManagerFactory(DataSource
	 * dataSource) { LocalContainerEntityManagerFactoryBean factoryBean = new
	 * LocalContainerEntityManagerFactoryBean();
	 * factoryBean.setDataSource(dataSource); factoryBean.setJpaVendorAdapter(new
	 * HibernateJpaVendorAdapter());
	 * factoryBean.setPackagesToScan("com.demo.springmvc.beans");
	 * factoryBean.setJpaProperties(getHibernateProperties()); return factoryBean; }
	 * 
	 * @Bean(name = "transactionManager") public JpaTransactionManager
	 * forTranstactionManager(EntityManagerFactory entityManagerFactory) { return
