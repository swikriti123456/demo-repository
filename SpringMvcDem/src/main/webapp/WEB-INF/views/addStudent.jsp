		...
		<div class="row justify-content-center">
			<div class="col-md-7">
				...
				<div class="jumbotron shadow-lg bg-light mt-1">
					...
					<div class="form-group row">
						...
						<div class="col-10">
							...
							<div class="input-group-text"><i class="fas fa-user"></i></div>
								...
								<form:input type="text" path="rollNo" cssClass="form-control"  cssErrorClass="form-control is-invalid" />
					...
					<form:button class="btn btn-block btn-left btn-success">Save</form:button>
					</div>
					</div>
					</form:form>
				</div>
